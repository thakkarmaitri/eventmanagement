      ...
      <div class="right_content">            
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <fieldset>
            ...
            <dl>
                        <dt>
                      <label for="etype">Event Photo:</label></dt>
...
<dl>
                <dt>
                      <label for="etype">Event Description:</label></dt>

                            <dd><textarea name="eadress"  rows="3" cols="36" id="FCKeditor1"></textarea>
                             <script type="text/javascript">
                    ...
                    <dl class="submit">
                    <input type="submit" name="add" id="add" value="Add" class="deep"/>
                     </dl>
