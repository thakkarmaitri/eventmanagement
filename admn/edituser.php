...
function rocc_check()
{
	if(document.getElementById("rocc").value.length == 0)
	{
		document.getElementById("rocc_msg").innerHTML="Please enter ocupation";
			document.getElementById("rocc_msg").style.color="red";
	}	
}
function ucontect_check()
{
	...
	{
		document.getElementById("mob_msg").innerHTML="Please fill contact no";
			document.getElementById("mob_msg").style.color="red";
	}
	else if(document.getElementById("mobno").value.length!=10)
	{
		document.getElementById("mob_msg").innerHTML="contact no must be 10 digit";
			document.getElementById("mob_msg").style.color="red";
	}
      ...
      <div class="right_content">            
        ...
        <form action="" method="post" enctype="multipart/form-data" onsubmit="return check()" >
          ...
          <table>
                    <tr>
                        ...
                        <td><input type="text" name="uname" id="uname" size="54"  value="<?php echo $array[1]; ?>" onblur="uname_check()" /><label id="uname_msg"></label></td>
                    </tr>
                    <tr>
                        <td>
                          <label for="interests">City:</label></td>
                        <td>
                          <input type="text" name="ucity" id="ucity" size="24"  value="<?php echo $array[3]; ?>" onblur="ucity_check()"/><label id="ucity_msg"></label>
                        </td>
                    </tr>
		...
		?>						    
                    ...
                    <tr>
                        ...
                        <td>
                          <input type="text" name="rocc" id="rocc" size="24"  value="<?php echo $array[6]; ?>" onblur="rocc_check()"/><label id="rocc_msg"></label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                          <input type="text" name="mobno" id="mobno" size="24"  value="<?php echo $array[11]; ?>" onblur="ucontect_check()"/><label id="mob_msg"></label>
                        </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <select size="1" name="umonth" id="umonth"  value="">
                          <option>Month</option>
                     ...
                     <tr>
                        ...
                        <td>
                            <input type="radio" name="type" id="male" value="1" /><label class="check_label">Male</label>
                            <input type="radio" name="type" id="female" value="2" /><label class="check_label">Female</label> 
                             <span id="msg"></span>                     
                        </td>
                    </tr>
                 <tr>
                 <td>
                  <label> Current User Type:</label></td>
                   <td>     
                      ...
                      <option value="2">Arhatic-1</option>
                      <option value="3">Crystel</option>
				          </select>
                 </td></tr>
                   
             <tr> 
             <td></td>      
          <td>  <input type="submit" name="sub" id="sub" value="Upadate" class="deep"/></td>
            </tr>
          </table>
