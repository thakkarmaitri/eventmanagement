...
<div id="main_container">
    ...
    <div class="right_header">Welcome <?php echo $_SESSION['name']; ?>,| <a href="#" class="logout">Logout</a></div>
    <div id="clock_a"></div>
    </div>
...
<?php
	if(isset($_POST['add']))
	{
	$str="insert into contect values(null,'".$_POST['einfo']."')";
	mysql_query($str);
	}
?>                                                       
          ...
          <fieldset>
            ...
            <dl>
              ...
              <label for="etype">Event Description:</label></dt>
                            ...
                            <dd><textarea name="einfo"  rows="3" cols="36" id="FCKeditor1"></textarea>
                             <script type="text/javascript">
